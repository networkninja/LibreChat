...
export function Artifact({
  ...
  // Pass the artifact directly - it already has the correct ID for this specific button
  // Each button in chat history should link to its own unique artifact version
