  ...
  const handleUploadClick = (
    ...
    if (fileType === 'image') {
      ...
      inputRef.current.accept =
        'image/*,.pdf,.txt,.md,.csv,.doc,.docx,.xls,.xlsx,.json,application/pdf,text/plain,text/markdown,text/csv,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet';
